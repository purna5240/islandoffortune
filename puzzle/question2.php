...
<body>
    ...
    <body style="background:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.7)), url('kingdom4.jpg');background-repeat: no-repeat; background-attachment: fixed;background-size: cover;background-color:rgba(0,0,0,0.5);">
        <img src="king2.svg" style="margin-right:1200px ;margin-left: 2500px;  width: 550px;
        height: 550px;     margin-top: 450px;   object-fit: cover;overflow-y: hidden;position: fixed;">
        
        <div style="position: relative;">
            <img src="bubble1.png" height="500px" width="700px" style="margin-left: 90px;" >
         <h1 style="margin-top:50px ;color: rgb(28, 13, 3);font-weight: bolder;font-family: 'MedievalSharp', cursive;font-size: 28px;padding-left: 90px;margin-top: 100px;position: absolute;
         bottom:160px;
         left: 26px;">
         <span style="color:green">  WELCOME TO MY VILLAGE HERE IS YOUR HINT TO NEXT VILLAGE  <br>  </span>
         <span id="question"></span>
                <button class="btn btn-outline-primary" type="button" id="button-addon1" onclick="answer_clicked();reset()" style="font-weight: bolder; position:relative;top:340px;right:370px;background-color: rgb(56, 56, 118);color: white;">SUBMIT</button>
                <form id="res">
                  <input type="text" class="form-control"  id="ans" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1"style="cursor: auto; position:relative;top:300px;left:0px"></div>
                </form>
              </div>
          </h1> </div>  
